...
public class TicTacToeClient extends Client
{
    ...
    public void process(String message)
    {
        ...
        else if("addpiece".equals(parts[0]))
        {
            ...
            System.out.println(Integer.parseInt(parts[1].substring(1,2)));
            System.out.println(Integer.parseInt(parts[2].substring(1,2)));
            game.addPiece(Integer.parseInt(parts[1].substring(1,2)), Integer.parseInt(parts[2].substring(1,2)));
            //game.nextPlayer();
            System.out.println(youAre);
            if (youAre != null)
                stage.updatePiece(youAre, Integer.parseInt(parts[1].substring(1,2)), Integer.parseInt(parts[2].substring(1,2)));
            game.nextPlayer();
