...
public class TicTacToeStage extends Stage
{
    ...
    private TicTacToePiece t3p;
    private PieceActor[][] pObj;
    ...
    public TicTacToeStage(TicTacToeClient client, TicTacToe game, TicTacToePiece piece)
    {
        ...
        //game = new TicTacToe();
        pObj = new PieceActor[3][3];
        this.game = game;
        t3p = piece;
        //USE T3P AS YOUARE TO COMPARE THE "IT IS YOUR TURN" INSTEAD OF CURR!!
    ...
    public void update()
    {
        if(game.isGameOver())
        {
            ...
            if(win == TicTacToePiece.X)
            {
                ...
                {
                    //currentPlayer.setText("You Lose!");
        ...
        else
        {
            ...
            if(t3p.equals(game.getCurrentPlayer()))
            {
                currentPlayer.setText("It is your turn");
            }
            else
    ...
    {
           System.out.println(piece + "," + t3p);
        pObj[row][col].setPiece(piece);
         //pObj[row][col].setPiece(t3p);
