...
public class MoveableAnimatedActor extends AnimatedActor
{
    ...
    public void act()
    {
        ...
        else if(Mayflower.isKeyDown(Keyboard.KEY_UP) && y > 0)
        {
            ...
            System.out.println("Begin of UP --> lastCurrentAction = " + lastCurrentAction + " ,currentAction = " + currentAction + " ,newAction = " + newAction + " , fall = " + fall + " ,jump = " + jump);
            setLocation(x, y - 1);
            ...
            else
            {
                ...
                System.out.println("End of UP --> lastCurrentAction = " + lastCurrentAction + " ,currentAction = " + currentAction + " ,newAction = " + newAction + " , fall = " + fall + " ,jump = " + jump);
            }
        }
